...
/*  CREATING TABLE AND DROPPING TABLES       
DDL SCRIPT : CRETING TABLES

**SCRIPT PURPOSE**
This script create table and drop tables if already exists and creating schemas like bonze and inserting all the tables into bronze layer ..
